...
import { faPlay, faPause, faStop, faMicrophone, faArrowRotateRight, faCalendarDays, faVolumeLow } from '@fortawesome/free-solid-svg-icons';
                                ...
                                <div className='tiles-main-block'>
                                    <div className='tiles-sub-block'>
                                        <div className='major-tiles'>
                                            <Link to="/answer" className='titit'><h2 className=''>Answers Title</h2></Link>
                            ...
                            <div className="audio-player qure-form">
                                ...
                                <div className='ask-form'>
                                    <form className="hi" onSubmit={handleSubmit}>
                                        ...
                                        <div className="i">
                                            <textarea className="llll  new-ll"
